...
const enGameData: GameData = {
  ...
  'gwi_ma_scheme': {
    ...
    dialogue: [
      ...
      { character: 'Jinu', emotion: 'demon', text: 'I understand, my lord. But what if...', position: 'right' },
      { character: 'Gwi-Ma', emotion: 'neutral', text: 'NO QUESTIONS! YOUR 400 YEARS OF SHAME BIND YOU TO ME!', position: 'left' },
      { character: 'Jinu', emotion: 'demon', text: '...Yes, master.', position: 'right' },
    ],
  ...
  'bridge_meeting': {
    ...
    dialogue: [
      ...
      { character: 'Jinu', emotion: 'human', text: 'You came. I wasn\'t sure you would.', position: 'right' },
      { character: 'Rumi', emotion: 'neutral', text: 'You said it was urgent. What\'s wrong?', position: 'left' },
      { character: 'Jinu', emotion: 'human', text: 'Gwi-Ma knows about you. About what you are. He\'s planning something for your next performance.', position: 'right' },
      { character: 'Rumi', emotion: 'surprised', text: 'What? How does he...?', position: 'left' },
      { character: 'Jinu', emotion: 'human', text: 'Because I told him. I was ordered to get close to you, to find your weakness.', position: 'right' },
  ...
  'betrayal_revelation': {
    ...
    dialogue: [
      ...
      { character: 'Jinu', emotion: 'human', text: 'But I\'m telling you now, aren\'t I? I\'m trying to warn you!', position: 'right' },
      { character: 'Rumi', emotion: 'angry', text: 'After you\'ve already sold me out! How can I believe anything you say?', position: 'left' },
      { character: 'Jinu', emotion: 'human', text: 'Because for the first time in 400 years, I met someone who made me remember what hope feels like.', position: 'right' },
...
const koGameData: GameData = {
  ...
  'gwi_ma_scheme': {
    ...
    dialogue: [
      ...
      { character: 'Jinu', emotion: 'demon', text: '알겠습니다, 주인님. 하지만 만약...', position: 'right' },
      { character: 'Gwi-Ma', emotion: 'neutral', text: '질문은 없다! 너의 400년 수치심이 나에게 묶여 있다!', position: 'left' },
      { character: 'Jinu', emotion: 'demon', text: '...네, 주인님.', position: 'right' },
    ],
    nextScene: 'rumi_performance_crisis',
    onEnter: [
      { type: 'set', flag: 'JinwooTrust', value: 0 },
  ...
  'bridge_meeting': {
    ...
    dialogue: [
      ...
      { character: 'Jinu', emotion: 'human', text: '왔구나. 올지 확신하지 못했어.', position: 'right' },
      { character: 'Rumi', emotion: 'neutral', text: '급하다고 했잖아. 무슨 일이야?', position: 'left' },
      { character: 'Jinu', emotion: 'human', text: '귀마가 너에 대해 알고 있어. 네가 무엇인지. 다음 공연에서 뭔가를 계획하고 있어.', position: 'right' },
      { character: 'Rumi', emotion: 'surprised', text: '뭐? 어떻게 그가...?', position: 'left' },
      { character: 'Jinu', emotion: 'human', text: '내가 말했거든. 너에게 접근해서 약점을 찾으라는 명령을 받았어.', position: 'right' },
  ...
  'betrayal_revelation': {
    ...
    dialogue: [
      ...
      { character: 'Jinu', emotion: 'human', text: '하지만 지금 말하고 있잖아, 그렇지? 널 경고하려고 하는 거야!', position: 'right' },
      { character: 'Rumi', emotion: 'angry', text: '이미 날 팔아넘긴 후에! 네가 하는 말을 어떻게 믿어?', position: 'left' },
      { character: 'Jinu', emotion: 'human', text: '400년 만에 처음으로, 희망이 무엇인지 기억나게 해준 사람을 만났거든.', position: 'right' },
  ...
  'final_choice_setup': {
    ...
    dialogue: [
      ...
      { character: 'Jinu', emotion: 'demon', text: '루미... 미안해. 맞서려 했지만, 귀마의 통제가...', position: 'center' },
